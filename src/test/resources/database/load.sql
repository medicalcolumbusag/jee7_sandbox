...
insert into SBE_ETN_MAP_HOSPITAL (CUST_ID, MATERIAL_ID, MC_ID, CREATE_USER, CREATE_DATE, SALES_UNIT, SPARTE, KREDITOR_ID ) values('77548','202491','545434','schmidtf',date('13.01.2014'),'Stück','M','9878787')
insert into SBE_ETN_MAP_HOSPITAL (CUST_ID, MATERIAL_ID, MC_ID, CREATE_USER, CREATE_DATE, SALES_UNIT, SPARTE, KREDITOR_ID ) values('77548','212491','542234','schmidtf',date('13.01.2014'),'Stück','M','32322323')

insert into SBE_ETN_MAP_HOSPITAL (CUST_ID, MATERIAL_ID, MC_ID, CREATE_USER, CREATE_DATE, SALES_UNIT, SPARTE, KREDITOR_ID ) values('71538','211191','542234','schulzp',date('21.01.2014'),'Stück','M','3232123')
